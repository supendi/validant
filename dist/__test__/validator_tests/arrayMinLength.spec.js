...
describe(`Test ${arrayMinLength_1.arrayMinLength.name}`, () => {
    it("should return false and have default error message", () => {
        const minValue = 1;
        const validator = (0, arrayMinLength_1.arrayMinLength)(minValue);
        const myArray = [];
...
describe(`Test ${arrayMinLength_1.arrayMinLength.name}`, () => {
    it("should return false and have custom error message", () => {
        ...
        const validator = (0, arrayMinLength_1.arrayMinLength)(minValue, customErrorMessage);
        const orderItems = [];
        expect(validator).not.toBeUndefined();
        expect(validator.validate).not.toBeUndefined();
