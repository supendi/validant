...
describe(`Test ${equalToPropertyValue_1.equalToPropertyValue.name}`, () => {
    it("should return false and have default error message", () => {
        ...
        const validator = (0, equalToPropertyValue_1.equalToPropertyValue)(testValue);
...
describe(`Test ${equalToPropertyValue_1.equalToPropertyValue.name}`, () => {
    it("should return false and have custom error message", () => {
        ...
        const validator = (0, equalToPropertyValue_1.equalToPropertyValue)(testValue, customErrorMessage);
