...
describe(`Test ${regularExpression_validator_1.regularExpression.name}`, () => {
    it("should return false and have default error message", () => {
        const testValue = /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[^a-zA-Z\d])([A-Za-z\d]|[^a-zA-Z\d]){8,}$/;
        const validator = (0, regularExpression_validator_1.regularExpression)(testValue);
        const defaultValidatorErrorMessage = `The value ':value' doesn't match withe the specified regular expression.`;
...
describe(`Test ${regularExpression_validator_1.regularExpression.name}`, () => {
    it("should return false and have custom error message", () => {
        ...
        const validator = (0, regularExpression_validator_1.regularExpression)(testValue, customErrorMessage);
