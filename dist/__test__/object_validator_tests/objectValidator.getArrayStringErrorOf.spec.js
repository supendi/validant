...
describe("getArrayStringErrorOf test with children array", () => {
    it("Children has to contain errors", () => {
        ...
        rule.children = {
            propertyValidators: [(0, minLength_validator_1.minLength)(1, "Please add at least one child.")],
            validationRule: rule
        };
        const person = {
            name: "",
...
describe("getArrayStringErrorOf test with Order and Order item", () => {
    it("Validating order item approach 1", () => {
        const rule = {
            ...
            orderItems: {
                propertyValidators: [(0, minLength_validator_1.minLength)(1, "Please add at least one order item.")],
                validationRule: {
...
describe("getArrayStringErrorOf test with Order and Order item", () => {
    it("Validating order item approach 2, separate the validation rule", () => {
        ...
        const rule = {
            ...
            orderNumber: [(0, required_validator_1.required)()],
            orderItems: {
                propertyValidators: [(0, minLength_validator_1.minLength)(3)],
...
describe("getArrayStringErrorOf complex validations", () => {
    it("Should return errors", () => {
        ...
        const rule = {
            ...
            orderItems: {
                propertyValidators: [(0, minLength_validator_1.minLength)(4)],
                validationRule: orderItemsRule
            }
        };
        const newOrder1 = {
