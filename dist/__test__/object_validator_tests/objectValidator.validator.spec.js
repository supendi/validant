...
describe("Validator test with children array", () => {
    it("Children has to contain elementErrors", () => {
        ...
        rule.children = {
            validatorOfArray: [(0, validators_1.arrayMinLength)(1)],
...
describe("Validator test with children array", () => {
    it("Children has to contain errors", () => {
        ...
        rule.children = {
            validatorOfArray: [(0, validators_1.arrayMinLength)(1, "Please add at least one child.")],
            validationRuleOfArrayElement: rule
        };
        const person = {
            name: "",
...
describe("Validator test with Order and Order item", () => {
    it("Validating order item approach 1", () => {
        const rule = {
            ...
            orderItems: {
                validatorOfArray: [(0, validators_1.arrayMinLength)(1, "Please add at least one order item.")],
...
describe("Validator test with Order and Order item", () => {
    it("Validating order item approach 2, separate the validation rule", () => {
        ...
        const rule = {
            ...
            orderNumber: [(0, validators_1.required)()],
            orderItems: {
                validatorOfArray: [(0, validators_1.arrayMinLength)(3)],
...
describe("Validator test maximum sum of", () => {
    it("Should return errors", () => {
        ...
        const rule = {
            ...
            orderItems: {
                validatorOfArray: [(0, validators_1.arrayMinLength)(4), (0, index_1.maxSumOf)("quantity", 10)],
                validationRuleOfArrayElement: orderItemsRule
            }
        };
        const newOrder1 = {
...
describe("Validator complex validations", () => {
    it("Should return a valid validation result", () => {
        ...
        const rule = {
            ...
            orderItems: {
                validatorOfArray: [(0, validators_1.arrayMinLength)(4)],
                validationRuleOfArrayElement: orderItemsRule
            }
        };
        const newOrder1 = {
