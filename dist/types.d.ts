 ...
 */
export type ValidationRule<T, TRoot = T> = {
    [key in keyof T]?: T[key] extends Date ? PropertyRuleFunc<T[key], TRoot>[] : T[key] extends PossiblyUndefined<Array<any>> ? ArrayValidationRule<T[key], T, TRoot> | ((value: T[key], objRef?: TRoot) => ArrayValidationRule<T[key], T, TRoot>) : T[key] extends PossiblyUndefined<object> ? ValidationRule<T[key], TRoot> : PropertyRuleFunc<T[key], TRoot>[];
};
/**
