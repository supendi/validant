...
import { elementOf, emailAddress, maxNumber, arrayMinLen, required, minNumber } from "../../rules"
import { minSumOf } from "../../rules/minSumOf"
...
describe("Validator Simple Person With Child Test", () => {
    it("Parent and child name should return errors", () => {
        ...
        const actual = valty.validate(parent, rule)
...
describe("Validator test with Order and Order item", () => {
    it("Validating order item approach 1", () => {
        ...
        const actual2 = valty.validate(newOrder2, rule)
...
describe("Validator Test Date Test", () => {
    it("Test date value", () => {
        ...
        const actual1 = valty.validate(product, rule)
