...
import { alphabetOnly } from "../../rules/alphabetOnly"
...
describe("getErrorOf Simple Person Test", () => {
    it("Person name should return errors", () => {
        ...
        const actual = validateObject(person, person, rule)
...
describe("getErrorOf Simple Person With Child Test", () => {
    it("Parent and child name should return errors", () => {
        ...
        const actual = validateObject(parent, parent, rule)
...
describe("getErrorOf test with Order and Order item", () => {
    it("Validating order item approach 1", () => {
        ...
        const actual1 = validateObject(newOrder1, newOrder1, rule)
        ...
        const actual2 = validateObject(newOrder2, newOrder2, rule)
...
describe("getErrorOf complex validations", () => {
    it("Should return errors", () => {
        ...
        const actual1 = validateObject(customer, customer, rule)
        ...
        const actual2 = validateObject(customer2, customer2, rule)
