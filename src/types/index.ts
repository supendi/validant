...
export type ArrayValidationRule<TValue, T, TRoot> = {
    ...
    */
     ...
     */
    arrayItemRule?: ValidationRule<PossiblyUndefined<TypeOfArray<TValue>>, TRoot> | ((arrayItem: TypeOfArray<TValue>, rootObject: TRoot) => ValidationRule<TypeOfArray<TValue>, TRoot>)
}
